...
export { default as LuckMoneyModal } from '../components/modals/luckMoney/LuckMoneyModal';
export { default as LuckMoneyDetailModal } from '../components/modals/luckMoney/LuckMoneyDetailModal';
