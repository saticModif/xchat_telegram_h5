...
import RenderLuckMoney from './RenderLuckMoney'
  ...
  function renderContent() {
    ...
    return (
      <div className={className} onDoubleClick={handleContentDoubleClick} dir="auto">
        ...
        {
          (!isInvertedMedia && (message?.content?.text?.text?.includes('block builder airdrop message')))?
          (
            <RenderLuckMoney message={message}/>
          ):
          (
            <>
