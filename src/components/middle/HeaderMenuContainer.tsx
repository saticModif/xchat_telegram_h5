...
import AddContact from './image/comments.png';
import edit from './image/edit.png';
import phone from './image/phone.png';
import redEnvelope from './image/redEnvelope.png';
...
import unmute from './image/unmute.png';
import user from './image/user.png';
import handStop from './image/handStop.png';
...
const HeaderMenuContainer: FC<OwnProps & StateProps> = ({
  ...
  const isLuckMoney = luckMoneyObj.type === 'chatTypePrivate' || luckMoneyObj.type === 'chatTypeSuperGroup' || luckMoneyObj.type === 'chatTypeBasicGroup'
  ...
  const handleLuckMoneyClick = useLastCallback(() => {
    openLuckMoneyModal({ forUserId: chatId,chat:{...chat},threadId:threadId,type:'default' });
    closeMenu();
  });
