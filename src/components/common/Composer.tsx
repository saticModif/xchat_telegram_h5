...
const Composer: FC<OwnProps & StateProps> = ({
  ...
  const handleSend = useLastCallback(async (isSilent = false, scheduledAt?: number) => {
    ...
    if (text) {
      ...
      // console.log(isSilent)
      // console.log('shouldUpdateStickerSetOrder')
      // console.log(shouldUpdateStickerSetOrder)
      // console.log('isInvertedMedia')
      // console.log(isInvertedMedia)
      // console.log('effectId')
      // console.log(effectId)
      // console.log('webPageMediaSize')
      // console.log(attachmentSettings.webPageMediaSize)
      // console.log('webPageUrl')
      // console.log(hasWebPagePreview)
      // console.log('end')
